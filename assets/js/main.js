...
const PRODUCTS = [
  {id:1,name:"VLADOK Hoodie • Black", price:5990, category:"Худи", img:"assets/images/product1.png", desc:"Тёплое худи премиум-кроя, матовая фактура, тёмное золото на фурнитуре."},
  {id:2,name:"URBAN Cap • Night", price:1490, category:"Кепка", img:"assets/images/product2.png", desc:"Классическая кепка с тиснением логотипа."},
  {id:3,name:"NIGHT Tee • Oversize", price:2990, category:"Футболка", img:"assets/images/product3.png", desc:"Мягкий хлопок 220 г, oversize посадка."},
  {id:4,name:"AURA Crossbody", price:4590, category:"Сумка", img:"assets/images/product4.png", desc:"Мини-сумка на ремне, водоотталкивающая пропитка."},
  {id:5,name:"SLICK Sunglasses", price:3990, category:"Аксессуар", img:"assets/images/product5.png", desc:"Лёгкая оправa с дымчатыми стеклами."},
  {id:6,name:"STEALTH Joggers", price:5990, category:"Штаны", img:"assets/images/product6.png", desc:"Удобная посадка, усиленные швы."},
  {id:7,name:"EDGE Belt", price:1990, category:"Аксессуар", img:"assets/images/product7.png", desc:"Кожаный ремень с металлической пряжкой."},
  {id:8,name:"VOLT Beanie", price:2390, category:"Шапка", img:"assets/images/product8.png", desc:"Тёплая шапка с фирменной эмблемой."}
];
